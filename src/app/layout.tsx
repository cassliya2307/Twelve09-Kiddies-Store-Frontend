...
export const metadata: Metadata = {
  ...
  title: {
    default: "Twelve09 Kiddies Store - Toys, Games & Educational Products for Children",
    template: "%s | Twelve09 Kiddies Store",
  },
  ...
  authors: [{ name: "Twelve09 Kiddies Store" }],
  creator: "Twelve09 Kiddies Store",
  publisher: "Twelve09 Kiddies Store",
  robots: "index, follow",
  openGraph: {
    type: "website",
    locale: "en_NG",
    url: "https://twelve09kiddiesstore.com",
    siteName: "Twelve09 Kiddies Store",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Twelve09 Kiddies Store",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Twelve09 Kiddies Store",
    description: "Discover joy in every toy! Shop our curated collection of educational toys, creative games, and delightful surprises for children of all ages.",
    images: ["/og-image.jpg"],
  },
  verification: {
